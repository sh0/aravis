...
arv_gc_feature_node_get_actual_access_mode (ArvGcFeatureNode *gc_feature_node)
{
	...
	if (ARV_GC_FEATURE_NODE_GET_CLASS (gc_feature_node)->get_access_mode != NULL)
		return ARV_GC_FEATURE_NODE_GET_CLASS (gc_feature_node)->get_access_mode (gc_feature_node);
...
arv_gc_feature_node_class_init (ArvGcFeatureNodeClass *this_class)
{
	...
	this_class->get_access_mode = arv_gc_feature_node_get_access_mode;
}
