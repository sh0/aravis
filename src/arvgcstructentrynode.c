...
{
	ArvGcStructEntryNode *self = NULL;

	g_return_val_if_fail (ARV_IS_GC_STRUCT_ENTRY_NODE (gc_feature_node), ARV_GC_ACCESS_MODE_RO);
	self = ARV_GC_STRUCT_ENTRY_NODE(gc_feature_node);
